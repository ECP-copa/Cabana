...
void perfTest( const double cutoff_ratio,
               ...
               const double cell_size_ratio )
{
    ...
    std::cout << "Cutoff distance to minimum distance ratio: "
              << cutoff_ratio << std::endl;
    std::cout << "Cell size to cutoff distance ratio: "
              << cell_size_ratio << std::endl;

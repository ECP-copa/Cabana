...
struct NeighborListTestData<3>
{
    ...
    double array_grid_min[3] = { box_min, box_min, box_min };
    double array_grid_max[3] = { box_max, box_max, box_max };
    double array_grid_delta[3] = { delta, delta, delta };
    std::array<double, 3> grid_min = { box_min, box_min, box_min };
    std::array<double, 3> grid_max = { box_max, box_max, box_max };
    std::array<double, 3> grid_delta = { delta, delta, delta };
...
struct NeighborListTestData<2>
{
    ...
    double cell_size_ratio = 0.5;
    double delta = cell_size_ratio * test_radius;
    std::array<double, 2> grid_min = { box_min, box_min };
    std::array<double, 2> grid_max = { box_max, box_max };
    std::array<double, 2> grid_delta = { delta, delta };

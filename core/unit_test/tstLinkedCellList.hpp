...
struct LCLTestData<3>
{
    ...
    double array_grid_delta[3] = { dx, dx, dx };
    double array_grid_min[3] = { x_min, x_min, x_min };
    double array_grid_max[3] = { x_max, x_max, x_max };
    std::array<double, 3> grid_delta = { dx, dx, dx };
    std::array<double, 3> grid_min = { x_min, x_min, x_min };
    std::array<double, 3> grid_max = { x_max, x_max, x_max };
...
struct LCLTestData<2> : public LCLTestData<3>
{
    ...
    // Create a grid.
    std::array<double, 2> grid_delta = { dx, dx };
    std::array<double, 2> grid_min = { x_min, x_min };
    std::array<double, 2> grid_max = { x_max, x_max };
...
{
    LCLTestData<3> test_data;
    auto grid_delta = test_data.array_grid_delta;
    auto grid_min = test_data.array_grid_min;
    auto grid_max = test_data.array_grid_max;

...
// Everything that is implementation dependent and not for the user is in a
// class indicating as much. The nicer high level user facing functions are at
// the vbottom of the file

...
class VerletList
{
  public:
    ...
    */
    ...
    {
        auto kokkos_min =
            Impl::copyArray<3, typename PositionType::value_type>( grid_min );
        auto kokkos_max =
            Impl::copyArray<3, typename PositionType::value_type>( grid_max );
...
template <class AlgorithmTag, class LayoutTag, class BuildTag,
          class PositionType, template <class, std::size_t> class ArrayType,

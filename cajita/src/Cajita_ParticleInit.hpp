...
template <class ExecutionSpace, class InitFunctor, class ParticleListType,
          class LocalGridType>
void createParticles( Cabana::InitRandom, const ExecutionSpace& exec_space,
...
void createParticles( Cabana::InitRandom tag, const InitFunctor& create_functor,
                      ParticleListType& particle_list,
                      const int particles_per_cell, LocalGridType& local_grid,
                      const bool shrink_to_fit = true,
                      const uint64_t seed = 123456 )
...
template <class ExecutionSpace, class InitFunctor, class ParticleListType,
          class LocalGridType>
void createParticles( Cabana::InitUniform, const ExecutionSpace& exec_space,
                      const InitFunctor& create_functor,
                      ParticleListType& particle_list,
...
*/
template <class InitFunctor, class ParticleListType, class LocalGridType>
void createParticles( Cabana::InitUniform tag,
                      const InitFunctor& create_functor,
                      ParticleListType& particle_list,
                      const int particles_per_cell, LocalGridType& local_grid,
                      const bool shrink_to_fit = true )

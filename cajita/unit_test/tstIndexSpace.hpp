...
void executionTest()
{
    ...
    Kokkos::parallel_for(
        "fill_rank_2",
        createExecutionPolicy(is2,TEST_EXECSPACE()),
    ...
    Kokkos::parallel_for(
        "fill_rank_3",
        createExecutionPolicy(is3,TEST_EXECSPACE()),
    ...
    int max_l = 9;
    int size_l = 14;
    IndexSpace<4> is4( {min_i,min_j,min_k,min_l}, {max_i,max_j,max_k,max_l} );
    Kokkos::View<double****,TEST_DEVICE> v4( "v4", size_i, size_j, size_k, size_l );
    Kokkos::parallel_for(
        "fill_rank_4",
        createExecutionPolicy(is4,TEST_EXECSPACE()),

  ...
  public:
    ...
    MPI_Comm getComm( const Array_t& array, const ArrayTypes&... arrays ) const
    {
        ...
        if ( result != MPI_IDENT && result != MPI_CONGRUENT )
            throw std::runtime_error( "Cabana::Grid::Halo::getComm: Arrays have different communicators" );
    ...
    auto getLocalGrid( const Array_t& array, const ArrayTypes&... arrays )
    {
        ...
        {
            throw std::runtime_error( "Cabana::Grid::Halo::getlocalGrid: Arrays have different halo widths" );
        }
        ...
        std::vector<Kokkos::View<int**, memory_space>>& steering )
    {
        ...
        if ( byte_counter != buffer_bytes )
            throw std::logic_error( "Cabana::Grid::Halo::buildSteeringVector: Steering vector contains different number "
